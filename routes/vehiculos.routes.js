...
[
    ...
    check('id').custom( existeVehiculoConId ),
    check('clase').custom( esClasePermitida ),
    check('patente','Debe ser un formato valido: LLLNNN o LLNNNLL para un auto. LNNNLLL o NNNLLL para moto. Donde L = Letra y N = Número.').matches(/([A-Z]{3})+([0-9]{3})(?![\w\d ])|([A-Z]{2})+([0-9]{3})+([A-Z]{2})(?![\w\d ])/gi),
